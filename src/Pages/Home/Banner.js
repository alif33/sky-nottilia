  ...
  return (
    <div className="">
      <div className="backgroundImg">
        <Navbar />
        <div>
          <h2 className="text-2xl lg:text-6xl text-center lg:pt-[124px] text-white ">
            Manage your Social
            <span className="block pt-2 lg:pt-5">media at a Glance!</span>
          </h2>
          ...
          <div className="flex justify-center items-center gap-5 text-white pb-[130px] lg:pb-[600px]">
      ...
      <div className="flex justify-center">
        <img
          className="mt-[-200px] lg:mt-[-700px]  lg:w-[1565px] lg:h-[1276px]"
          src={laptop}
          alt=""
          srcset=""
        />
