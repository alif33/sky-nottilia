...
const SignIn = () => {
  return (
    <div className="bg-[#E5E3E3] flex justify-between items-center px-3 lg:px-12 lg:py-5">
      <div className="w-[350px] h-[681px] lg:ml-[100px]">
        <h2 className="text-[#233B58] text-5xl font-semibold mt-10">
          Login in to
          <span className="block mt-1">your account</span>
        </h2>
        <div className="mt-[50px]">
          <form>
            ...
            <Link to="/forgot-password" className="text-[#474DDC] ">
              Forgot Password?
            </Link>
            <button className="w-[350px] h-[60px] bg-[#7C5CFC] text-white font-semibold rounded-[5px] mt-[40px]">
              Login
            </button>
            <button className="w-[350px] h-[60px] text-[#233B58] font-semibold bg-white rounded-[5px] mt-[15px]">
              <img className="inline mr-2" src={Google} alt="" srcset="" />
              Login with Google
            </button>
          </form>
