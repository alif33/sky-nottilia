...
const SignUp = () => {
  return (
    <div className="bg-[#E5E3E3] flex justify-between items-center lg:px-12 px-3 py-1">
      <div className="w-[350px] h-[721px] lg:ml-[100px]">
        <h2 className="text-[#233B58] text-4xl font-semibold lg:mt-10 mt-3 lg:text-left text-center">
          Create account
        </h2>
        <div className="lg:mt-[50px] mt-10">
          ...
          <p className="font-normal mt-[20px]">
